...
import com.ruyuan2020.little.project.rocketmq.admin.dto.AdminHotelRoomMessage;
import com.ruyuan2020.little.project.rocketmq.admin.dto.AdminRoomDescription;
import com.ruyuan2020.little.project.rocketmq.admin.dto.AdminRoomPicture;
...
import static com.ruyuan2020.little.project.rocketmq.common.constants.RedisKeyConstant.HOTEL_ROOM_KEY_PREFIX;
...
public class AdminRoomServiceImpl implements AdminRoomService {
    ...
    public CommonResponse add(AdminHotelRoom adminHotelRoom) {
        ...
        redisApi.set(HOTEL_ROOM_KEY_PREFIX + adminHotelRoom.getId(), JSON.toJSONString(adminHotelRoom),
            adminHotelRoom.getPhoneNumber(), LittleProjectTypeEnum.ROCKETMQ);
    ...
    private void sendRoomUpdateMessage(String phoneNumber, Long roomId) {
        ...
        message.setTopic(hotelRoomTopic);// 主题
        ...
        if (Objects.equals(commonResponse.getCode(), ErrorCodeEnum.SUCCESS.getCode())) {
            ...
            List<AdminHotelRoom> hotelRoomDetailList = mapList.stream().map(map -> {
                ...
                detailDTO.setRoomDescription(
                    JSON.parseObject(String.valueOf(map.get("description")), AdminRoomDescription.class));
