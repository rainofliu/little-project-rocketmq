package com.ruyuan2020.little.project.rocketmq.api.pay.service.impl;
...
public class PayTransactionServiceImpl implements PayTransactionService {
    ...
    public Boolean save(PayTransaction payTransaction, String phoneNumber) {
        ...
        mysqlRequestDTO.setSql(
            "INSERT INTO pay_transaction(" + "order_no, " + "total_order_amount, " + "payable_order_amount, "
                + "user_pay_account, " + "transaction_channel, " + "transaction_number, " + "finish_pay_time, "
                + "response_code, " + "status, " + "gmt_create, " + "gmt_modified " + ") VALUES(" + "?, " + "?, "
                + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "?, " + "? " + ")");
